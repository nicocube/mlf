...
module.exports = (function () {
    ...
    wrk.prototype.forEach = function() {
        
    }

    mlf.prototype.forEach = function(f, t) { var _ = this._, i = 0, l = _.length, g = f.bind(t); for (; i < l ; i+=1) { var v = g(_[i], i, _); if (typeof v ==='boolean' && !v) break; } }
    mlf.prototype.reduce = function(f, p) { var _ = this._, i = arguments.length > 1 ? 0 : 1, l = _.length; p = arguments.length > 1 ? p : _[0]; for (; i < l ; i+=1) { p = f(p ,_[i] ,i , _) }; return p }
